...
class MainMenu(Frame):
    ...
    def initFrame(self):
        # title
        title = Label(self, text="Welcome to Casting Manager",
        ...
        image = PhotoImage(
            file="/home/zakary/Documents/uni/h24/2935/projet_session/app/ressources/logo.png")
        ...
        search_button = create_button(button_container, "Search",
                                      lambda: self.parent.switch_frame(
                                          SearchMenu))
        search_button.pack(side=LEFT, padx=10)

        # button to new
        new_button = create_button(button_container, "New",
